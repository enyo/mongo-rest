...
MongoRest.prototype.collectionPost = function() { return _.bind(function(req, res, next) {
  ...
  this.invokeInterceptors(req.params.resource, 'post', info, req, res, next, function() {
    ...
    model.save(function(err) {
      ...
      self.invokeInterceptors(req.params.resource, event, info, req, res, next, function() {
...
MongoRest.prototype.entityGet = function() { return _.bind(function(req, res, next) {
  ...
  this.invokeInterceptors(req.params.resource, 'get', info, req, res, next, onFinish);
...
MongoRest.prototype.entityPut = function() { return _.bind(function(req, res, next) {
  ...
  this.invokeInterceptors(req.params.resource, 'put', info, req, res, next, function() {
...
MongoRest.prototype.entityDelete = function() { return _.bind(function(req, res, next) {
  ...
  this.invokeInterceptors(req.params.resource, 'delete', info, req, res, next, function() {
    req.doc.remove(function(err) {
      if (err) {
        info.err = err;
        self.invokeInterceptors(req.params.resource, 'delete.error', info, req, res, next, function() {
          next(err);
        });
      }
      else {
        self.invokeInterceptors(req.params.resource, 'delete.success', info, req, res, next, function() {
          res.redirect(self.options.urlPath + req.params.resource);
        });
      }
    });
