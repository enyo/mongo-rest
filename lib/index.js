...
(function() {
  ...
  MongoRest = (function() {
    ...
    MongoRest.prototype.serializeDataObject = function(obj, child) {
      var key, serializedObj, val, value;
      if (child == null) {
        child = false;
      }
      if (!child) {
        ...
        if (value instanceof Array) {
          value = (function() {
            ...
            for (_i = 0, _len = value.length; _i < _len; _i++) {
              val = value[_i];
              _results.push(this.serializeDataObject(val, true));
            }
            return _results;
          }).call(this);
    ...
    MongoRest.prototype.deserializeDataObject = function(obj) {
      var deserializedObject, key, val, value;
      deserializedObject = {};
      for (key in obj) {
        value = obj[key];
        ...
        if (value instanceof Array) {
          value = (function() {
            ...
            for (_i = 0, _len = value.length; _i < _len; _i++) {
              val = value[_i];
              _results.push(this.deserializeDataObject(val));
            }
            return _results;
          }).call(this);
        } else if (typeof value === "object") {
